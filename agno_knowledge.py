...
from enhanced_text_reader import EnhancedTextReader


class AgnoKnowledgeBase(AgentKnowledge):
    path: Optional[Union[str, Path, List[Dict[str, Union[str, Dict[str, Any]]]]]] = None
    formats: List[str] = [".py",".md", ".txt"]
    reader: EnhancedTextReader = EnhancedTextReader(chunk=True, chunk_size=500)
